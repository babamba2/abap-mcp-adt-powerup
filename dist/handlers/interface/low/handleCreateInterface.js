...
async function handleCreateInterface(context, args) {
    ...
    try {
        const { interface_name, description, package_name, transport_request, session_id, session_state, } = args;
        // Validation
        if (!interface_name || !description || !package_name) {
            return (0, utils_1.return_error)(new Error('interface_name, description, and package_name are required'));
        }
