...
exports.handleLockMetadataExtension = handleLockMetadataExtension;
 ...
 */
async function handleLockMetadataExtension(context, args) {
    ...
    try {
        ...
        try {
            ...
            const lockHandle = await client
                ...
                .lock({ name: ddlxName });
            if (!lockHandle) {
                throw new Error(`Lock did not return a lock handle for metadata extension ${ddlxName}`);
            }
...
//# sourceMappingURL=handleLockMetadataExtension.js.map