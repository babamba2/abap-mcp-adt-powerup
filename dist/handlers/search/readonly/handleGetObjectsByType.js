...
async function handleGetObjectsByType(context, args) {
    ...
    try {
        ...
        const response = await utils.fetchNodeStructure(parent_type, parent_name.toUpperCase(), node_id, withDescriptions);
        if (outputFormat === 'raw') {
        ...
        if (objects.length === 0) {
            ...
            const plainResult = (0, utils_1.return_response)(mockResponse);
            getObjectsListCache_1.objectsListCache.setCache(plainResult);
            return plainResult;
        }
        ...
        const finalResult = (0, utils_1.return_response)(mockResponse);
...
//# sourceMappingURL=handleGetObjectsByType.js.map