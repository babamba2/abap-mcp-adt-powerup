 ...
 */
async function handleValidateClass(context, args) {
    ...
    try {
        ...
        if (!class_name || !package_name || !description) {
            return (0, utils_1.return_error)(new Error('class_name, package_name, and description are required'));
        }
...
//# sourceMappingURL=handleValidateClass.js.map