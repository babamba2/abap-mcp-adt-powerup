...
이 프로젝트는 [mario-andreschak/mcp-abap-adt](https://github.com/mario-andreschak/mcp-abap-adt)와 [fr0ster/mcp-abap-adt](https://github.com/fr0ster/mcp-abap-adt/tree/main/src)에서 영감을 받았습니다. 핵심 아이디어를 기반으로 독자적인 아키텍처와 기능으로 발전시킨 프로젝트입니다.
